	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'3d-hover': '0 20px 40px -5px rgba(0, 0, 0, 0.4)'
			},
			fontFamily: {
			...
			keyframes: {
				...
				'glow': {
					...
					'50%': { filter: 'brightness(1.2) drop-shadow(0 0 30px rgba(139, 92, 246, 0.6))' }
				}
			},
			animation: {
			...
			backgroundImage: {
				...
				'hero-gradient': 'linear-gradient(135deg, #8B5CF6 0%, #0EA5E9 50%, #F97316 100%)'
			}
		}
	},
