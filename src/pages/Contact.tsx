              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@avinashsingh.com" className="text-gray-600 hover:text-brand-purple transition-colors">contact@avinashsingh.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Bareilly, Uttar Pradesh, India</p>
                  </div>
                </div>
              </div>
